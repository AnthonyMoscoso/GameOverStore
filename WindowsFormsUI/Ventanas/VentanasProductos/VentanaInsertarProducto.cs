    ...
    public partial class VentanaInsertarProducto : Form
    {
       ...
       // Image notFound = Image.FromFile(Path.GetFullPath(@"_Imagenes\Iconos\imageNotFound.png"));
        ...
        private void chekedp(object sender, EventArgs e)
        {
            ...
            Plataformas p = _servicioPlataformas.Get("Nombre='" + c.Text + "'");
            if (c.Checked)
            {
        ...
        private void ptbxHorz_Click(object sender, EventArgs e)
        {
            ...
            if (txtPtbxHz.Text.Trim().Length > 0)
            {
                ...
                {
                    ptbxChange.Image = Image.FromFile(ImagenControls.ImageNotFound);
            ...
            {
                ptbxChange.Image = Image.FromFile(ImagenControls.ImageNotFound);
                ptbxHorz.Image = Image.FromFile(ImagenControls.ImageNotFound);
            }
        ...
        private void ptbxVer_Click(object sender, EventArgs e)
        {
            ...
            {
                ptbxChange.Image = Image.FromFile(ImagenControls.ImageNotFound);
                ptbxVer.Image = Image.FromFile(ImagenControls.ImageNotFound);
            }
        }
        ...
        private void ptbxLogo_Click(object sender, EventArgs e)
        {
            ...
            {
                ptbxChange.Image = Image.FromFile(ImagenControls.ImageNotFound);
                ptbxLogo.Image = Image.FromFile(ImagenControls.ImageNotFound);
            }
        ...
        private void btnOpenDialogPicture_Click(object sender, EventArgs e)
        {
            ...
            {
                ImagenControls.OpenFileDialogImage(alertPicture, ptbxHorz, txtPtbxHz, 250000);
                ptbxChange.Image = ptbxHorz.Image;
            }
            else if (PICTURE_TYPE == PICTURE_VERTICAL)
            {
                ImagenControls.OpenFileDialogImage(alertPicture, ptbxVer, txtPtbcV, 250000);
                ptbxChange.Image = ptbxVer.Image;
            }
            else
            {
                ImagenControls.OpenFileDialogImage(alertPicture, ptbxLogo, txtPtbxLogo, 250000);
                ptbxChange.Image = ptbxLogo.Image;
            }
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            if (IsValidProducto())
            {
                ...
                p.Nombre = txtName.Text.TrimEnd();
                p.Introduccion = txtIntroduccion.Text.TrimEnd();
                p.Descripcion = txtDescripcion.Text.TrimEnd();
                ...
                p.Imagen_Vertical = ImagenControls.SaveImagenIn(RUTA_IMAGENES_PRODUCTOS, txtPtbcV.Text, p.Nombre);
                p.Imagen_Horizontal = ImagenControls.SaveImagenIn(RUTA_IMAGENES_PRODUCTOS, txtPtbxHz.Text, p.Nombre);
                p.Imagen_Logo = ImagenControls.SaveImagenIn(RUTA_IMAGENES_PRODUCTOS, txtPtbxLogo.Text, p.Nombre);
                p.Url = txtVideo.Text.TrimEnd();
        ...
        private void pnBodyImagen_Paint(object sender, PaintEventArgs e)
        {
